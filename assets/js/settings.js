...
async function run(){
  ...
  root.innerHTML=`
    <div class="hero"><div><h2>Setup and privacy</h2><p>Import your broker CSV, enable protected cloud sync, export backups and manage symbol, sector and ETF mappings.</p></div></div>
    <div class="grid two">
