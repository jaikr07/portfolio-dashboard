const CACHE='jkr-investments-v4.2.2';
const SHELL=['./','./index.html','./offline.html','./manifest.webmanifest','./assets/css/styles.css?v=4.2.2','./assets/js/config.js','./assets/js/utils.js','./assets/js/pwa.js?v=4.2','./assets/js/auth-gate.js?v=4.2','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/icons/jkr-dark.png','./assets/icons/jkr-light.png','./assets/icons/favicon-32.png'];
